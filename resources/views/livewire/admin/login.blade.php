    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="{{ route('admin') }}" class="h1">
                <img src="{{ asset('images/essay-help-logo.svg') }}" alt="{{ env('APP_NAME') }} Logo">
            </a>
        </div>
        <div class="card-body">
            ...
            <form wire:submit="auth">
                ...
                @enderror
                @if(session()->has('incorrect_student_admin_password'))
                    <small class="text-danger">
                        <em>{{ session('incorrect_student_admin_password') }}</em>
                    </small>
                @endif
                <div class="row mt-3">
                    <div class="col-md-12">
