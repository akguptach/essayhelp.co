                                        ...
                                        <tbody>
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b>{{ $order->student->first_name }} {{ $order->student->last_name }}</b> <br>
                                                        <small>{{ $order->student->email }}</small> <br>
                                                        <small>{{ $order->student->phone_number }}</small>
                                                    </td>
                                                    <td>
                                                        <b>{{ $order->subject->subject_name }}</b> <br>
                                                        <small>{{ $order->referencingStyle->style }}, {{ $order->taskType->type_name }}</small> <br>
                                                        <small>{{ $order->studyLevel->level_name }}, {{ $order->grade->grade_name }}</small>
                                                    </td>
                                                    <td>{{ $order->no_of_words }}</td>
                                                    <td>{{ $order->price }} {{ strtoupper($order->currency_code) }}</td>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($order->delivery_date)->format('jS F, Y') }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
