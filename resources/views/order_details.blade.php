                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <p>{{$data->subject->subject_name}} - {{$data->taskType->type_name}}
                                ...
                                <div class="chat-group-box mt-4">
                                    <div class="user-chat-name">
                                        <div class="user-photo">
                                            ...
                                            <img src="{{ asset('images/avatar5.png')}}" class="img-fluid"
                                                alt="Essay Help" title="Essay Hel" loading="lazy" width="32"
                                                height="32">
                                            @else
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-secondary border-0" type="button"
                                            ...
                                            <label class="input-group-text" for="inputGroupFile01">
                                                <img src="{{ asset('images/basil_attach-solid.svg')}}" class="img-fluid"
                                                    loading="lazy" alt="Essay Help" title="Essay Help" width="24"
                                                    height="24">
                                            </label>
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            style="border-top-right-radius: 12px;border-bottom-right-radius: 12px;">Send</button>
                                    </div>
                                </form>
