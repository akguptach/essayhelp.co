        ...
        <section class="mb-5 mt-5">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-6">
                            <picture>
                                <img src="{{ asset('images/Get_physics_EssayPro.png') }}" class="card-img-top" alt="Essay Help" title="Essay Hel"
                                    loading="lazy" width="374" height="374">
                            </picture>
                    </div>
                    <div class="col-md-6">
                        <div class="we-work-content">
                            <h3 class="text-header">Get physics help at EssayPro</h3>
                            <p>Students can request a full refund within 30 days of their order. However, this is extremely rare as most students are 100% satisfied with their essays after edits are completed. We take every effort to make sure the students who order research papers from us are never let down.</p>
        
                            <p>If you have a unique perspective, experience, thoughts, or advice from your side of the fence, you can get paid to write personal essays…in just about any niche. But you need to know where to look when learning how to make money writing, and how to pitch an editor when you do.</p>
                        </div>
                    </div>
                </div>
            </div>
