            ...
            <div class="container">
                 <div class="row d-flex align-items-center">
                    <div class="col-md-6">
                        <div class="">
                          <picture>
                                <img src="{{ asset('images/Edit_My_Essay.jpg') }}" class="card-img-top" alt="Essay Help" title="Essay Hel"
                    ...
                    <div class="col-md-6">
                        <div class="we-work-content">
                            <h3 class="text-header">Edit My Essay</h3>
                            <p>Editing is important because it helps to ensure that a document is free of grammatical, punctuation and spelling errors. Editing also allows for the improvement of clarity and flow. This is done by rearranging sentences and paragraphs and adding or removing information where necessary.</p>
        
                            <p>Editing is a process that involves revising the content, organization, grammar, and presentation of a piece of writing. The purpose of editing is to ensure that your ideas are presented to your reader as clearly as possible.</p>
                        </div>
                    </div>
                </div>
                    </div>
