            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-md-6">
                        <div class="card ">
                            <picture>
                                <img src="{{ asset('images/Buy_dissertation_onlin.png') }}" class="card-img-top" alt="Essay Help" title="Essay Hel"
                    ...
                    <div class="col-md-6">
                        <div class="we-work-content">
                            <h3 class="text-header">Buy dissertation online</h3>
                            <p>Students buy dissertations online because they are available for an affordable price, and buying a dissertation saves the time and effort needed to develop an excellent one. Want to buy a dissertation? We can write a dissertation according to your institution's academic standards and requirements!.</p>
        
                            <p>When completing a graduate degree program, students are required to produce a major research and writing project, such as a dissertation in a doctoral program or thesis in a master's program.</p>
